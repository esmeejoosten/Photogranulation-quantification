...
column.1 <- c(1,14,27,40,53,66) #e.g., the first particle detected corresponds to the first particle in the first column of the scanner grid, the fourteenth particle detected is situated on the grid in column 1, row 3, etc.
...
row.1 <- c(1,2,3,4,5,6,7) #e.g., the first particle detected corresponds to the most left particle in the first row of the grid, etc. 
